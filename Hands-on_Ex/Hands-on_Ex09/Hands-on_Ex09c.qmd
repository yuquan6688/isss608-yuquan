...
In this hands-on exercise, I will using R to plot static and interactive heatmap for visualising and analysing multivariate data.

# 2 Installing and Launching R Packages

Next, I will use the code chunk below to install and launch seriation, heatmaply, dendextend and tidyverse in RStudio.
